...
const Icons = {
  ...
  // ================================================================
  // ICONOS FALTANTES – FIX: estos se usaban con data-icon en el HTML
  // pero no existían en la librería, así que nunca se mostraban.
  // ================================================================
  ...
  // Alias para compatibilidad con data-icon="alert" y data-icon="arrow-up-down"
  alert: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>`,
  'arrow-up-down': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 16V4m0 0L3 8m4-4l4 4"/><path d="M17 8v12m0 0l4-4m-4 4l-4-4"/></svg>`,
};

// --------------------------------------------------------------------------
// Función utilitaria para construir un span con el SVG (uso programático)
// --------------------------------------------------------------------------
